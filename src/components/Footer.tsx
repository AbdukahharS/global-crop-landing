...
const Footer = () => {
  ...
  return (
    <footer id="contact" className='bg-primary text-white flex flex-col items-center py-10 sm:py-12 lg:py-16 rounded-t-[30px] sm:rounded-t-[45px] lg:rounded-t-[60px] px-4 sm:px-6 relative'>
        ...
        <div className='flex flex-row lg:flex-col gap-6 sm:gap-8 lg:gap-10 justify-center'>
          <button className='flex flex-row items-center gap-3 sm:gap-4 lg:gap-6'>
            <img
              src={Telegram}
              alt='Telegram'
              className='w-8 h-8 sm:w-10 sm:h-10 lg:w-auto lg:h-auto'
            />
            <img
              src={AngleRight}
              alt='Angle Right'
      ...
      <h2 className='font-bold text-5xl sm:text-7xl lg:text-[160px] text-[#FFFFFF12] mt-8 sm:mt-12 lg:mt-0 relative z-10'>
        GLOBAL CROP
      </h2>
    </footer>
  )
